...
[![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/premheroku8/Yuii-String)
...
1. Clone the repo
   ```markdown
   git clone https://github.com/BionXP/StringSessionBot
   ```
